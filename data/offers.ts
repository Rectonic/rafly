...
export const OFFERS: Offer[] = [
  ...
  },
  {
    ...
    restaurant: "Le Pain",
    image:
      "https://images.unsplash.com/photo-1586444248902-2f64eddc13bf?w=900&q=80",
    oldPrice: 12,
    newPrice: 3.5,
    discount: 71,
    distance: "3.1 km",
  ...
  },
  {
    ...
    location: {
      lat: 41.3005,
      lng: 69.29712,
      address: "Yakkasaroy District, Tashkent",
    },
  },
  {
    id: "6",
  ...
  },
  {
    ...
    cancellationPolicy:
      "Cancel up to 30 minutes before pickup for an automatic refund.",
    contents: ["Croissants", "pain au chocolat", "fruit danishes"],
    dietaryBadges: ["Vegetarian"],
    pickupInstructions:
      "Use the side bakery entrance and show your pickup code at the counter.",
    quantityAvailable: 9,
    location: {
      lat: 41.33177,
      lng: 69.30091,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1546069901-d5bfd2cbfb1f?w=900&q=80",
    oldPrice: 19,
    newPrice: 7.5,
    discount: 61,
    distance: "3.3 km",
