...
## v3, картун-мир, итоговое направление (вечер 31.08)

Решение основателя после аниматика v2: рисованный мультяшный мир в духе энергичной рекламной анимации, гэги, весёлые переходы. Фотореал-диорама отменена: независимые генерации не держат один мир, аниматик рассыпался на несвязанные кадры.

Стиль v3: тушь, акварель, преувеличенные пропорции, лёгкий юмор. Герой: усатый владелец лавки в зелёной доппе и бирюзовом фартуке. Финал: владелец с крыльями над махаллёй (окрылённость как образ).

Уроки генерации, обязательные к соблюдению:

1. Слова «Red Bull» в промпте достаточно, чтобы FLUX нарисовал настоящие банки с логотипом быков. Товарный знак в конкурсном ролике недопустим. Бренды в промптах запрещены, суффикс несёт «no brand logos, generic blank packaging only».
2. Головной убор персонажа дрейфует между кадрами. Частично лечится детальным каноном («flat square green-and-white patterned doppa»), остаточный дрейф принимается как рисованный шарм.
3. Крупный план товара провоцирует псевдоэтикетки. Лечится «plain unlabeled, completely blank packaging» в каноне объекта.
4. Kling любит разворачивать персонажа лицом. Для видов со спины в негатив обязательно «turning around, face, front view».

Кейфреймы v3: docs/pta/film/gen/stills-cartoon. Клипы: docs/pta/film/gen/clips-cartoon.
